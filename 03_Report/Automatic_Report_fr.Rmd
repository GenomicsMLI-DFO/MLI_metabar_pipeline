...
Le tag jumping et les contaminants ont un effet sur le nombre de reads observés par échantillon. Certains échantillons peuvent présenter très peu de reads, par exemple parce qu'il y a eu de l'inhibition de la réaction PCR, ou que le locus utilisé est trop spécifique.   
