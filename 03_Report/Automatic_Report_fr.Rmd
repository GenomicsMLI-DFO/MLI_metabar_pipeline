...
Chaque MOTU peut être classé dans une catégorie.
...
graph.artefact.motus <-  summary.artefact.motus  %>% 
  ...
  labs(fill="Category") + 
  coord_polar(theta="y") + theme_void() + 
  scale_fill_manual(limits = c("Not artefactual", "Contamination"), values = c("deepskyblue1", "darkorange1" ), labels = c("Detected MOTUs", "Contamination")) + 
...
- Les singletons (MOTU à 1 read) pourraient être retirés.
